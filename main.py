...
class Play:
    ...
    def blackjack(self):
        ...
        show_dealer_card = pygame.image.load('resources/cards/' + self.dealer.card_img[1] + '.png').convert()
    ...
    def deal(self):
        ...
        self.player_card = 1
        dealer_card = pygame.image.load('resources/cards/' + self.dealer.card_img[0] + '.png').convert()
        dealer_card_2 = pygame.image.load('resources/cards/cardback.png').convert()

        player_card = pygame.image.load('resources/cards/' + self.player.card_img[0] + '.png').convert()
        player_card_2 = pygame.image.load('resources/cards/' + self.player.card_img[1] + '.png').convert()
    ...
    def hit(self):
        ...
        if self.player_card == 2:
            self.player.calc_hand()
            self.player.display_cards()
            player_card_3 = pygame.image.load('resources/cards/' + self.player.card_img[2] + '.png').convert()
            gameDisplay.blit(player_card_3, (520, 450))

        if self.player_card == 3:
            self.player.calc_hand()
            self.player.display_cards()
            player_card_4 = pygame.image.load('resources/cards/' + self.player.card_img[3] + '.png').convert()
